...
import { MediaThemeNeo } from '../../src/media-theme-neo.js';
MediaThemeNeo.prototype.hotReplacedCallback = function hotReplacedCallback() {
...
export default {
  ...
  plugins: [
    ...
    hmrPlugin({
      ...
      baseClasses: [{ name: 'MediaThemeNeo', import: './src/media-theme-neo.js' }],
